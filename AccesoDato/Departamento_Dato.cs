...
namespace AccesoDato
{
    public class Departamento_Dato
    {
         ...
         public void Insert(Departamento_Entidad cliente_entidad)
        {
            ...
            cmd.Parameters.Add("@fecharegistro", SqlDbType.VarChar, 100).Value = cliente_entidad.fecharegistro;
        ...
        public DataTable LISTADODEPROPIETARIO()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select idprop,apellidos from propietario", con.con);
            da.SelectCommand.CommandType = CommandType.Text;
            DataTable dt = new DataTable();
